# [#](https://www.xfyun.cn/doc/spark/asr_llm/rtasr_llm.html#实时语音转写大模型)实时语音转写大模型
...
[实时语音转写大模型产品页面](https://www.xfyun.cn/services/rtasr)
[实时语音转写大模型服务页](https://console.xfyun.cn/services/new_rta)
...
| 字段名称      | 类型   | 是否必须 | 字段说明                                                     |
| ------------- | ------ | -------- | ------------------------------------------------------------ |
| appId         | string | 是       | 讯飞开放平台应用id，从开放平台[控制台 ](https://console.xfyun.cn/services/new_rta)获取 |
| accessKeyId   | string | 是       | 讯飞开放平台应用key，从开放平台[控制台 ](https://console.xfyun.cn/services/new_rta)获取 |
...
为提高用户在自身业务场景的识别准确度，支持在[控制台 ](https://console.xfyun.cn/services/new_rta)上传专业词汇，以提高相应的识别权重。
...
[Python 代码示例](https://xfyun-doc.xfyun.cn/lc-sp-rtasr_llm_demo-1767597748832.zip)

[Java 代码示例](https://xfyun-doc.xfyun.cn/lc-sp-RTASR_LLM_java-1767597788322.zip)
